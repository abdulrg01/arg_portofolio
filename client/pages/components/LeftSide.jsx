  ...
  return (
    <div className="flex flex-col w-full h-full items-center justify-end gap-4 text-gray-300">
      <div className="flex flex-col gap-4">
        <a href="https://www.linkedin.com/in/auwal-abubakar-%E2%9A%A1-a54908125?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">
        ...
        <a href="https://x.com/rg_auwal?t=ygYqwcmV8ynAuYqitMzoog&s=09" target="_blank">
          <span className="w-10 h-10 text-xl bg-slate-800 dark:bg-slate-900 rounded-full inline-flex items-center justify-center hover:text-green-300 cursor-pointer hover:translate-y-2 transition-all duration-300">
            <SlSocialTwitter />
          </span>
        </a>
        <a href="https://www.facebook.com/Auwalabubakarg?mibextid=ZbWKwL" target="_blank">
          <span className="w-10 h-10 text-xl bg-slate-800 dark:bg-slate-900 rounded-full inline-flex items-center justify-center hover:text-green-300 cursor-pointer hover:translate-y-2 transition-all duration-300">
            <SlSocialFacebook />
          </span>
        </a>
        <a href="https://www.instagram.com/auwal_rg?igsh=amc0bXBla2Z1ZzJp" target="_blank">
          <span className="w-10 h-10 text-xl bg-slate-800 dark:bg-slate-900 rounded-full inline-flex items-center justify-center hover:text-green-300 cursor-pointer hover:translate-y-2 transition-all duration-300">
            <SlSocialInstagram />
          </span>
        </a>
